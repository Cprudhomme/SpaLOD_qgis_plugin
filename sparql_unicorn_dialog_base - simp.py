...
super(SPAQLunicornDialog, self).__init__(parent)
    ...
    self.actionQueryTemplates.currentIndexChanged.connect(self.viewselectaction)
    ...
    self.actionSave_Query.clicked.connect(self.saveQueryFunc)
    ...
    self.actionLoad_Layer_Enrichment.clicked.connect(self.loadLayerForEnrichment)
